                ...
                <div class="row">
                  <div class="col-md-9">
                    ...
                    <div class="forum-sub-title">
                      Talk about sports, entertainment, music, movies, your
                      favorite color, talk about enything.
                    </div>
                  </div>
              ...
              <div class="forum-item">
                <div class="row">
                  <div class="col-md-9">
                    ...
                    <div class="forum-sub-title">
                      New to the community? Please stop by, say hi and tell us a
                      bit about yourself.{" "}
                    </div>
                  </div>
                  <div class="col-md-1 forum-info">
              ...
              <div class="forum-item active">
                <div class="row">
                  <div class="col-md-9">
                    ...
                    <div class="forum-sub-title">
                      This forum features announcements from the community
                      staff. If there is a new post in this forum, please check
                      it out.{" "}
                    </div>
                  </div>
                  <div class="col-md-1 forum-info">
              ...
              <div class="forum-item">
                <div class="row">
                  <div class="col-md-9">
                    ...
                    <div class="forum-sub-title">
                      This forum is for private, staff member only discussions,
                      usually pertaining to the community itself.{" "}
                    </div>
                  </div>
                  <div class="col-md-1 forum-info">
