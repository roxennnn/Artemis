import enCategories from './categories/en_categories';
...
export default {
  ...
  SignupPage: {
    ...
    notAWoman: 'Not a woman?',
    notAnOrganisation: 'Not an organisation?',
    signupQuestion: 'Don\'t have an account yet? Register for free!',
    citizenSignUp: 'Woman Registration',
    organisationSignUp: 'Organisation Registration',
  ...
  Profile: {
    ...
    ProfileSurveys: {
      ...
      youMustAnswerToAllTheQuestions: 'You must answer to all the questions!',
      DemographicsSurvey: {
        title: 'Demographic survey',
        description:
          'Sharing with us some of your personal information will help us create your profile and get to know you better.',
        introduction:
          'By filling this section, you will help us create your profile and understand your background. This is very important because it will further contriubute to finding the right job for you, fit for your age, location schedule, etc. Your information is kept confidential.',
